...
hsml_dir = pre_home + 'code/proj-an-c/HsmlAndProject_OMP/'
emtab_sylvia_ssh = pre_data + ('iontab/lineem/lines_sp20/UVB_dust1_CR1_G1'
                               '_shield1_lines.hdf5') 
...
path_jscoolingflow = '/home/naw0231/code/'
